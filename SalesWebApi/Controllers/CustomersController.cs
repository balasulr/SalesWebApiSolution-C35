...
namespace SalesWebApi.Controllers {
    ...
    // Controller can send and receive JSON data
    public class CustomersController : ControllerBase {
        ...
        public async Task<ActionResult<IEnumerable<Customer>>> GetCustomers() { 
            ...
            // GetCustomers is the method // IEnumerable is a collection of customers coming back   // ActionResult returns different types
        ...
        // The customer is a instance of a customer
        public async Task<IActionResult> PutCustomer(int id, Customer customer) {
            if (id != customer.Id) {
                return BadRequest(); // If say going to change customer number 2 but pass up customer number 1 then it will say that not Found
            }
